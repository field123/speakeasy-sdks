 ...
 */
export type ListJobsResponseBody = {
    data?: Array<components.Job> | undefined;
...
export type ListJobsResponse = {
     ...
     * Success. A list of jobs is returned.
     */
    object?: ListJobsResponseBody | undefined;
};
...
export namespace ListJobsRequest$ {
    ...
    export const inboundSchema: z.ZodType<ListJobsRequest, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListJobsRequest> = z
        .object({
            filter: z.string().optional(),
...
/** @internal */
export namespace ListJobsResponseBody$ {
    export type Inbound = {
        data?: Array<components.Job$.Inbound> | undefined;
        links?: Record<string, components.Link$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<ListJobsResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
            data: z.array(components.Job$.inboundSchema).optional(),
    ...
    export type Outbound = {
        data?: Array<components.Job$.Outbound> | undefined;
        links?: Record<string, components.Link$.Outbound> | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListJobsResponseBody> = z
        .object({
            data: z.array(components.Job$.outboundSchema).optional(),
...
export namespace ListJobsResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        object?: ListJobsResponseBody$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<ListJobsResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ContentType: z.string(),
            StatusCode: z.number().int(),
            RawResponse: z.instanceof(Response),
            object: z.lazy(() => ListJobsResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
    ...
    export type Outbound = {
        ...
        StatusCode: number;
        RawResponse: never;
        object?: ListJobsResponseBody$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListJobsResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
            ...
            object: z.lazy(() => ListJobsResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                ContentType: v.contentType,
