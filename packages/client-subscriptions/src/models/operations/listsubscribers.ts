...
export type ListSubscribersResponseBody = {
    data?: Array<components.Subscriber> | undefined;
...
export type ListSubscribersResponse = {
     ...
     * Success. A list of subscribers is returned.
     */
    object?: ListSubscribersResponseBody | undefined;
};
...
export namespace ListSubscribersRequest$ {
    ...
    export const inboundSchema: z.ZodType<ListSubscribersRequest, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListSubscribersRequest> = z
        .object({
            filter: z.string().optional(),
...
export namespace ListSubscribersResponseBody$ {
    export type Inbound = {
        data?: Array<components.Subscriber$.Inbound> | undefined;
        links?: Record<string, components.Link$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<ListSubscribersResponseBody, z.ZodTypeDef, Inbound> = z
        .object({
            data: z.array(components.Subscriber$.inboundSchema).optional(),
    ...
    export type Outbound = {
        data?: Array<components.Subscriber$.Outbound> | undefined;
        links?: Record<string, components.Link$.Outbound> | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListSubscribersResponseBody> = z
        .object({
            data: z.array(components.Subscriber$.outboundSchema).optional(),
...
export namespace ListSubscribersResponse$ {
    export type Inbound = {
        ...
        StatusCode: number;
        RawResponse: Response;
        object?: ListSubscribersResponseBody$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<ListSubscribersResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ContentType: z.string(),
            StatusCode: z.number().int(),
            RawResponse: z.instanceof(Response),
            object: z.lazy(() => ListSubscribersResponseBody$.inboundSchema).optional(),
        })
        .transform((v) => {
            return {
    ...
    export type Outbound = {
        ...
        StatusCode: number;
        RawResponse: never;
        object?: ListSubscribersResponseBody$.Outbound | undefined;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListSubscribersResponse> = z
        .object({
            ...
            object: z.lazy(() => ListSubscribersResponseBody$.outboundSchema).optional(),
        })
        .transform((v) => {
            return {
                ContentType: v.contentType,
